...
public class DelayedTasksViewModel extends ViewModel {
    ...
    public DelayedTasksViewModel(AppointmentDAO appointmentDAO) {
        this.appointmentDAO = appointmentDAO;
    }

    // A method to get the LiveData object
    public LiveData<List<Appointment>> getAppointments(String status) {
    ...
    public LiveData<List<Appointment>> getDelayedEvents() {
        return getAppointments("delayed");
    }
}